...
export class UserService {
  constructor(
    private readonly userConverter: UserConverter, // 替代 UserConverter
  ...
  async getUserInfo(): Promise<User> {
    let user = {
      ...
      levelName: 'VIP1',
      tianCai: false,
      icon: 'https://outside-dev-static.v2.jiuxiao2.cn/outside/fms/img/c5509ce0b5f049b58e2d91219b2e18b8.png',
