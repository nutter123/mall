...
export async function findAllAdminUser(options?: { [key: string]: any }) {
  return request<API.AdminUser[]>('/test-api/user', {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function deleteManyAdminUser(body: string[], options?: { [key: string]: any }) {
  return request<any>('/test-api/user', {
    method: 'DELETE',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function findAdminUserById(
  ...
  return request<API.AdminUser>(`/test-api/user/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function updateAdminUser(
  ...
  const { id: param0, ...queryParams } = params;
  return request<any>(`/test-api/user/${param0}`, {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function loginAdminUser(body: API.LoginAdminDto, options?: { [key: string]: any }) {
  return request<string>('/test-api/user/login', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function registerAdminUser(body: API.CreateAdminUserDto, options?: { [key: string]: any }) {
  return request<API.AdminUser>('/test-api/user/register', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
